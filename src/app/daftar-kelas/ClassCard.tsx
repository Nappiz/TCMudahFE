    ...
    >
      ...
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="flex flex-wrap gap-2 mb-6 mt-auto">
          {isPackage ? (
            <span className="inline-flex items-center gap-1.5 rounded-md border border-amber-500/30 bg-amber-500/10 px-2 py-1 text-[10px] font-bold text-amber-400 tracking-wider uppercase">
              📦 Paket Bundle
            </span>
          ) : (
