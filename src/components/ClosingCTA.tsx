...
export default function ClosingCTA() {
  return (
    <section className="relative py-32 overflow-hidden bg-slate-950 flex flex-col items-center justify-center">
      ...
      <div className="z-10 absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(6,182,212,0.1)_0%,transparent_70%)] blur-2xl hidden md:block" />
      <div className="z-10 absolute inset-0 bg-[url('/noise.svg')] opacity-[0.05] mix-blend-overlay pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <FadeIn>
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-950/30 text-cyan-300 text-sm font-medium mb-8 backdrop-blur-sm"
          >
        ...
        <FadeIn delay={300}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            <Link href="/daftar-kelas" className="w-full sm:w-auto">
              <button 
                className="cursor-pointer group relative w-full sm:w-auto px-8 py-4 bg-white text-slate-950 rounded-full font-bold text-lg overflow-hidden shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] transition-transform hover:scale-105 active:scale-95"
              >
            ...
            <a href="https://wa.me/6281519291757" target="_blank" className="w-full sm:w-auto">
              <button 
                className="cursor-pointer w-full sm:w-auto px-8 py-4 rounded-full border border-white/10 text-white font-medium hover:bg-white/5 transition-colors active:scale-95 transition-transform hover:scale-105"
              >
                Konsultasi Gratis
              </button>
            </a>
